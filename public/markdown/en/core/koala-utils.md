...
- New subpaths: [`operators`](https://utils.koalarx.com/markdown/en/operators/overview.md) (frontend) and [`prototypes`](https://utils.koalarx.com/markdown/en/prototypes/overview.md) (backend, opt-in in `main`)
- Full guide: [Migration 5.0](https://utils.koalarx.com/markdown/en/guides/migration-5.md) · LLM index: [llms-en.txt](https://utils.koalarx.com/llms-en.txt)
...
On the frontend prefer [`@koalarx/utils/operators`](https://utils.koalarx.com/markdown/en/getting-started/frontend-vs-backend.md); on the backend, opt-in [`prototypes`](https://utils.koalarx.com/markdown/en/prototypes/overview.md) in the entry file. Do not use `pipe()`.

See the [@koalarx/utils documentation](https://utils.koalarx.com/) (LLM index: [llms-en.txt](https://utils.koalarx.com/llms-en.txt)) for the full method list.
