...
- Novos subpaths: [`operators`](https://utils.koalarx.com/markdown/pt/operators/visao-geral.md) (frontend) e [`prototypes`](https://utils.koalarx.com/markdown/pt/prototypes/visao-geral.md) (backend, opt-in no `main`)
...
No frontend preferir [`@koalarx/utils/operators`](https://utils.koalarx.com/markdown/pt/inicio/frontend-vs-backend.md); no backend, [`prototypes`](https://utils.koalarx.com/markdown/pt/prototypes/visao-geral.md) opt-in no entry. Não use `pipe()`.
